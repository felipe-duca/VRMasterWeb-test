...
describe('Pedido de Venda', () => {
    ...
    it('Cadastro de Pessoa Cliente', () => {
        ...
        cy.get(LOC.OPERACAO.CADASTRO.PESSOA.CADASTRO_ABA_DADOS_PESSOA_FISICA_NOME).type('Teste 11')
    ...
    it('Cadastro de Produto', () => {
        ...
        cy.get(LOC.OPERACAO.CADASTRO.PRODUTO.CADASTRO_ABA_DADOS_GERAIS_DESCRICAO).type('Produto Teste Cypress 4')
        cy.get(LOC.OPERACAO.CADASTRO.PRODUTO.CADASTRO_ABA_DADOS_GERAIS_INPUT_DESCRICAO_CUPOM).type('Produto Cypress 4')
        cy.get(LOC.OPERACAO.CADASTRO.PRODUTO.CADASTRO_ABA_DADOS_GERAIS_INPUT_DESCRICAO_GONDOLA).type('Produto Teste Cypress 4')
    ...
    it('Cadastro de Pedido de Venda', () => {
        ...
        cy.get(LOC.VENDA.PEDIDO_DE_VENDA.CADASTRO_SELECT_BUSCA_CLIENTE).type('Teste 11')
        cy.get(LOC.VENDA.PEDIDO_DE_VENDA.SELECT_ITEM('Teste 11')).click()
        ...
        cy.get(LOC.VENDA.PEDIDO_DE_VENDA.CADASTRO_MODAL_PRODUTO_INPUT_DESCRICAO).type('Produto Teste Cypress 4')
        cy.get(LOC.VENDA.PEDIDO_DE_VENDA.CADASTRO_MODAL_PRODUTO_DATATABLE_ROW('Produto Teste Cypress 4')).within(() => {
